mehdi@atlas:~/Shaya/ws/mci/mediagateway$ go build main.go
mehdi@atlas:~/Shaya/ws/mci/mediagateway$ ./main serve


docker build .-t mediagateway:latest


docker run mediagateway:latest -p  8080:8080
...
See the [`/test`](tests/README.md) directory for examples.
